...
public final class ConfigCache {
    ...
    public boolean isCountdownSoundEnabled() {
        return countdownSoundEnabled;
    }

    public Sound getCountdownSoundType() {
        return countdownSoundType;
    }
    ...
    public float getCountdownSoundPitch() {
        return countdownSoundPitch;
    }

    public boolean isActivatedSoundEnabled() {
        return activatedSoundEnabled;
    }

    public Sound getActivatedSoundType() {
        return activatedSoundType;
    }

    public float getActivatedSoundVolume() {
        return activatedSoundVolume;
    }

    public float getActivatedSoundPitch() {
        return activatedSoundPitch;
    }

    public boolean isDeactivatedSoundEnabled() {
        return deactivatedSoundEnabled;
    }

    public Sound getDeactivatedSoundType() {
        return deactivatedSoundType;
    }

    public float getDeactivatedSoundVolume() {
        return deactivatedSoundVolume;
    }

    public float getDeactivatedSoundPitch() {
        return deactivatedSoundPitch;
    }
